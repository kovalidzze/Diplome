...
public class breakfastСlass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breakList.setAdapter(
                new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, titlesbreak));
        ...
        breakList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                intentb.setClass(breakfastСlass.this, DetailActivity.class);
